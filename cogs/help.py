...
class Help(commands.Cog):
    ...
    async def help(self, ctx, *, args : str = None):
        if args == None:
            embed = discord.Embed(title='도움말', description='안녕하세요! 아래의 명령어들을 이용해 도움말을 보세요!', color=CoCo_Color)
            ...
            embed = discord.Embed(title='기본 명령어', description='안녕하세요? 기본적인 명령어를 알려줄게요!', color=CoCo_Color)
            ...
            embed = discord.Embed(title='게임 명령어', description='저를 통해 할 수 있는 게임의 명령어들을 알려줄게요!', color=CoCo_Color)
            ...
            embed = discord.Embed(title='음악 명령어', description='음악과 관련된 명령어를 알려줄게요!', color=CoCo_Color)
            ...
            embed = discord.Embed(title='관리자 명령어', description='관리자만 사용 가능한 명령어를 알려줄게요!', color=CoCo_Color)
            ...
            embed.add_field(name='`/mute <뮤트할 유저>`', value='시끄러운 사람들을 조용히 있게 해줄게요.', inline=True)
            embed.add_field(name='`/unmute <언뮤트할 유저>`', value='조용해진 사람들을 말할 수 있게 해줄게요.', inline=True)
